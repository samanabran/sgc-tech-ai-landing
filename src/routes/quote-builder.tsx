...
const QbIcons: Record<string, string> = {
  ...
  brain: '<path d="M9.5 2A2.5 2.5 0 0 1 12 4.5a2.5 2.5 0 0 1-2.5 2.5c-.83 0-1.5.67-1.5 1.5a2.5 2.5 0 0 1-2.5 2.5c-1.38 0-2.5-1.12-2.5-2.5 0-.83.67-1.5 1.5-1.5H4a2.5 2.5 0 0 1 2.5-2.5A2.5 2.5 0 0 1 9 2h.5z"/><circle cx="17" cy="6.5" r="2.5"/><circle cx="15" cy="13.5" r="2.5"/>',
  rocket: '<path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74.5 5-2c.71-.84.7-2.18-.06-2.88-.76-.7-2-.7-2.94-.12z"/><path d="M12 15l3-3a2.5 2.5 0 0 1 3.5 3.5c0 1.5-2.5 2.5-2.5 2.5s-2.5-1-2.5-2.5A2.5 2.5 0 0 1 12 15z"/><path d="M12 2v6"/><path d="M5.5 8.5l3-3"/><path d="M18.5 8.5l-3-3"/>',
}
    ...
    <>
      ...
      <section class="qb-step" id="qb-step-industry">
        <div class="qb-step-header">
          ...
          {/* Clear All button */}
          <button type="button" class="btn btn-ghost qb-clear-all" id="qb-clear-all" title="Clear all selections">
            <QbIcon name="x" size={14} /> Clear All
          </button>
        </div>
        
        {/* Pre-defined Builds */}
        <div class="qb-predefined-builds" id="qb-predefined-builds">
          <p class="qb-predefined-label">Or choose a pre-built package:</p>
          <div class="qb-builds-row">
            <button type="button" class="qb-build-btn" data-build-id="starter">
              <QbIcon name="rocket" size={16} />
              <span>Starter AI</span>
              <em>AED 2,400/mo</em>
            </button>
            <button type="button" class="qb-build-btn" data-build-id="pro">
              <QbIcon name="briefcase" size={16} />
              <span>Professional</span>
              <em>AED 7,900/mo</em>
            </button>
            <button type="button" class="qb-build-btn" data-build-id="enterprise">
              <QbIcon name="building" size={16} />
        ...
        <div class="qb-industries" id="qb-industries">
          {INDUSTRIES.map(ind => (
            <button
              class={`qb-industry-card glass ${ind.isSpecial ? 'qb-industry-special' : ''}`}
              ...
              data-is-special={ind.isSpecial ? 'true' : 'false'}
              type="button"
              aria-pressed="false"
            >
              <span class="qb-ind-icon"><QbIcon name={ind.icon} size={32} /></span>
              <span class="qb-ind-name">{ind.name}</span>
              {ind.isSpecial ? (
                <span class="qb-ind-cost">Request Quote</span>
              ) : (
                <>
